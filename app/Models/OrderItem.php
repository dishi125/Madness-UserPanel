...
class OrderItem extends Model
{
    ...
    protected $appends = ['product_title','item_image','attributename','attributetermname','item_quantity','order_item_price','sub_discount','total_item_amount','item_payable_amt'];
