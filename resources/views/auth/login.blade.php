                ...
                <div class="card login-form mb-0">
                    <div class="card-body pt-5">
                        ...
                        <form method="post" action="" class="mt-5 mb-5 login-input" id="LoginForm">
                            ...
                            <a href="{{ route('forget.password.get') }}" class="pull-right text-primary">Forgot Your Password?</a>
                        </form>
                        <p class="mt-5 login-form__footer">Don't have account? <a href="{{ url('register') }}" class="text-primary">Sign Up</a> now</p>
                    </div>
                </div>
            </div>
        </div>
